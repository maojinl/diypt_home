...
<div class="tab-inner-content">
    ...
    <div id="divNotStarted" class="text-center" runat="server" Visible="false"><h2>Your program will not start until the next Monday</h2></div>
        <div class="col-sm-12" id="divMeasurement" runat="server">
           <p><span style="font-size:18px"><strong>Oooh yeah, it's that time... measurement time!</strong></span><br />Some of you have been looking forward to it and others dread it. Either way, what's the point of having a goal if you can't measure how you're going? <br />
Click here to view the video on how to perform your <a href="#" data-toggle="modal" data-target="#takeGirth" style="color:#e53478">Girth Measurements.</a><br />
If applicable, <a href="#" data-toggle="modal" data-target="#takeHeartRate" style="color:#e53478">click here for instructions on how to take your resting heart rate</a>.</p><br /><br />
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Measuring Resting heart rate</h5>
            ...
            <div class="modal-body">
                <p><ul>
<li>Take it first thing in the morning while seated, not standing.</li>
<li>Place your index and middle finger on either your carotid artery (neck) or your radial artery (inside of your wrist)</li>
<li>Count the number of beats you feel in 60 seconds.</li></ul></p>
...
<div class="modal fade" id="takeGirth" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <p>As the saying goes, you can't compare apples with oranges. Same with comparing photos. They have to be identical. <a href="#" data-toggle="modal" data-target="#takeSelfie" style="color:#e53478">Click here</a> for instructions on how to take consistent progress photos.</p>
...
<div class="modal fade" id="takeSelfie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" align-text="center">PROGRESS PHOTO TIPS</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p><b>When it's time to do your measurements and progress photos once a month, make sure you take the photo on the same day, same time and same place.</b><br />
<ul>
<li>Arms straight and by your side with palms facing up</li>
<li>Men take shirt off showing bare chest. Women take shirt off with sports bra on.</li>
<li>Wear plain dark clothes, preferably all black but must be wearing short shorts (must be able to see thighs)</li>
<li>Wear the same outfit for every progress photo</li></ul>
</p>
<p>
<b>Taking front and side photo</b><br />
<ul>
<li>Take photos in front of a full length mirror which shows your whole body from head to toe.</li>
<li>Take the photo from the same distance every time.</li>
<li>You can hold the camera with one hand to the side of your face, for example. Just make it the same every time.</li>
<li>No filter</li></ul>
</p>
<p><b>NOTE: The back shot will always be the hardest one to take.</b></p>


                <img class="img-fluid  img-round mb-2" src="/images/measurements/selfie-front.jpg"><br />
                <img class="img-fluid  img-round" src="/images/measurements/selfie-side.jpg"><br />
                <img class="img-fluid  img-round" src="/images/measurements/selfie-back.jpg"><br />
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
