...
<div class="tab-inner-content show-pg-b">
    <div class="d-flex justify-content-end content-nav-action sec mb-4">
        <a id="dayView2" class="c_grey" href="/orientation/day-4"> <img src="/images/icon-back-g.svg" /><span class="hidden-sm-down">BACK TO DAY VIEW ></span></a>
    ...
    <div class="row pb-4 pt-4">
        <a href="/orientation/day-4/video-5-kitchen-makeover-tips" id="btn-result" class="c_b btn btn-secondary m-1 col-sm-4 push-sm-4">TASK COMPLETED ></a>
    </div>
    <div class="row">
        <div class="col-lg-10 push-lg-1 ">
            <div class="k-result" id="k-result-1">
                <h5>32 to 63 points</h5>
                <p>You scored high on the kitchen makeover questionnaire. But this high score means you may need some adjustments to your kitchen set-up or your shopping habits. That’s no problem though. Watch my video, <a href="#" target="_blank">5 kitchen makeover tips</a> for some proven strategies you can implement to help get your kitchen into shape.</p>
            </div>
            <div class="k-result" id="k-result-2">
                <h5>0 to 31 points</h5>
                <p>Your kitchen environment could also use some improvements. Watch my video, <a href="#" target="_blank">5 kitchen makeover tips</a> for some proven strategies. Just choose 2 of the strategies and your kitchen will be back in tip top shape.</p>
            </div>
            <div class="k-result" id="k-result-3">
                <h5>-31 to -1 points</h5>
                <p>You’re doing pretty well in the kitchen department. With just a few tweaks, it'll be easier than ever to improve your body composition, energy levels and performance. Watch my video, <a href="#" target="_blank">5 kitchen makeover tips</a> to help you with the small tweaks.</p>
            </div>
            <div class="k-result" id="k-result-4">
                <h5>-32 to -63 points</h5>
                <p>Don’t let negative scores fool you. In this questionnaire, negative scores means a great kitchen environment. Nice work. In the coming weeks I’ll be happy to share even more strategies for keeping the great kitchen environment going. You can start by watching my video, <a href="#" target="_blank">5 kitchen makeover tips</a>.</p>
            </div>
        </div>
    </div>
</div>
