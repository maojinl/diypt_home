...
<div class="tab-inner-content show-pg-b">
    <div class="d-flex justify-content-end content-nav-action sec mb-4">
        <a id="dayView2" class="c_grey" href="/orientation/day-5"> <img src="/images/icon-back-g.svg" /><span class="hidden-sm-down">BACK TO DAY VIEW ></span></a>
    ...
    <div class="row pb-4 pt-4">
        <a href="/orientation/day-5/video-social-support-crew" id="btn-result" class="c_b btn btn-secondary m-1 col-sm-4 push-sm-4">TASK COMPLETED ></a>
    </div>
    <div class="row">
        <div class="col-lg-10 push-lg-1 ">
            <div class="k-result" id="k-result-1">
                <h5>28 to 38 total points:</h5>
                <p>Congratulations, it looks like you've got a great social support network around you, a group of people that'll help support your desire to change some of your daily practices. Of course, thats not all you'll need to be successful. But it’s a great start. Check out our video - <a href="#" target="blank"> Your Social Support crew.</a>
                </p>
            </div>
            <div class="k-result" id="k-result-2">
                <h5>5 to 27 total points:</h5>
                <p>It looks like you’ve got some social support around you but there may be a few areas that will present challenges. Being aware of your social temptations, as indicated above, is a great place to begin. Also check out our video - <a href="#" target="blank">Your Social Support crew </a>, and together with other DIYPTers, we can work on strategies for being successful in the face of your challenges.
                </p>
            </div>
            <div class="k-result" id="k-result-3">
                <h5>4 to -14 total points:</h5>
                <p>Your social support is lacking and may need a makeover. However, you’re not alone here. Many people struggle with social support. And that’s why I encourage you to be vocal in your Revitalise Me Zone because there are many more like you so I want us all to be in each others social support crew. Also, check out our video - <a href="#" target="blank">Your Social Support crew </for more ideas on how you can improve your social support crew.
                </p>
            </div>
            <div class="k-result" id="k-result-4">
                <h5>-15 to -31 total points:</h5>
                <p>This score is quite low and may signal some definite challenges in your work and at - home environments, as well as in your relationships. These can lead to old habits surfacing as many food related problems are really relationship and environment problems. Watch our video - <a href="#" target="blank">Your Social Support crew </a> for tips on how to improve your social support crew and be vocal in your Revitalise Me Zone. Make comments and ask as many questions as you want because together we’ll work on overcoming your challenges. 
                </p>
            </div>
        </div>
    </div>
