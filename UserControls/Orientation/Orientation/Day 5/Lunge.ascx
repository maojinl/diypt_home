<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Lunge.ascx.cs" Inherits="UserControls_Orientation_Day_5_Lunge" %>
<div class="tab-inner-content">
    ...
    <div class="text-center">
        <h1><strong>Day 5 - Task 3</strong></h1>
    ...
    <div class="d-flex justify-content-between align-items-center pb-4 pre-next">
        <a id="dayPre" class="day-pre c_y" href="/orientation/day-5/video-social-support-crew">Back</a>
        <a id="dayNext" class="day-next c_y" href="/orientation/day-5">Next</a>
    </div>
    <div class="row">
        <div class="col-lg-10 push-lg-1">
            <h1 class="text-center mb-3">GET FAMILIAR WITH THE LUNGE</h1>
            <div class="row mb-4">
                <div class="col-sm-12">
            ...
            <h5 class="c_y mt-4">Today’s exercise is the lunge.</h5>
            <p>So that means that you’ll be learning one exercise per day.</p>
            <p>Today’s exercise is the lunge. However, depending on your program, I want you to focus on a particular variation of the lung</p>
            <div class="row loc-home pg-t pg-l">
                <div class="col-md-4 ori-1-3-demo mb-4">
                    <img class="img-fluid" src="/images/ori/day1/demo.jpg" />
                    <h4 class="sec c_y mt-2 mb-2">ROOKIE</h4>
                    <p><strong>Alternating lunges</strong></p>
                    <a href="#" class="c_y">View demo ></a>
                </div>
                <div class="col-md-4 ori-1-3-demo mb-4">
                    <img class="img-fluid" src="/images/ori/day1/demo.jpg" />
                    <h4 class="sec c_y mt-2 mb-2">SOPHOMORE</h4>
                    <p><strong>Walking lunges</strong></p>
                    <a href="#" class="c_y">View demo ></a>
                </div>
                <div class="col-md-4 ori-1-3-demo mb-4">
                    <img class="img-fluid" src="/images/ori/day1/demo.jpg" />
                    <h4 class="sec c_y mt-2 mb-2">EXPERT</h4>
            ...
            <hr/>
            <a href="/orientation/day-5" class="text-center-sp btn btn-secondary  c_y">TASK COMPLETED ></a>
        </div>
    </div>
</div>