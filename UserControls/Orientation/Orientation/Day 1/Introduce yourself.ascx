...
<div class="tab-inner-content">
    <div class="d-flex justify-content-end content-nav-action f-sec mb-4">
        <a id="dayView2" class="c_grey" href="/orientation/day-1"> <img src="images/icon-back-g.svg" /><span class="hidden-sm-down">BACK TO DAY VIEW ></span></a>
        ...
        <div class="col-sm-10 push-sm-1">
            ...
            <div class="row mb-4">
                <div class="col-sm-7">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2"><a href="#" class="btn btn-secondary btn-block c_y">UPDATE MY PROFILE ></a></div>
            ...
            <div class="row mb-4">
                <div class="col-sm-7">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2"><a href="#" class="btn btn-secondary btn-block c_y">SEE REVITALISE ME ></a></div>
                        <div class="col-md-6 mb-2">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input"> ACTION COMPLETED
 ...
 <hr/>
            <a href="/orientation/day-1/pre-ex-questionnaire" class="text-center-sp btn btn-secondary  c_y">TASK COMPLETED ></a>
        </div>
    </div>
</div>