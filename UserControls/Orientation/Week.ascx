    ...
    <div class="row mb-4">
        ...
        <div style="margin: 0 auto" id="divOrientation" runat="server">
            <table class="table-week-ori table-sm table-responsive">
                ...
                <tr>
                    <td rowspan="3" class="text-center v-m">
                        <p>DAY 6</p>
                    ...
                    <td class="no-border-right">
                        ...
                        <!--<a class="weeklink" data-num="6-2" href="/orientation/day-6/mark-on-your-calendar-diary-any-events">Mark on your calendar/diary any events</a>
                            <a class="weeklink" data-num="6-3" href="/orientation/day-6/mark-on-your-calendar-diary-your-shopping-days">Mark on your calendar/diary your shopping days</a>
                ...
                <tr>
                    <td class="no-border-right">
                        <a class="weeklink" data-num="6-5" href="/orientation/day-6/get-familiar-with-the-twist">Get familiar with the twist</a>
                    </td>
                    <td>
