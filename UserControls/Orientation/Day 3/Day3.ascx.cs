...
public partial class UserControls_Orientation_Day_3_Day3 : BaseOrientation
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string result = dbAccess.GetOrientationWeekDayResult(myPlan.Id, 3);
            if (result != null)
            {
                if (result[0] == '1')
    ...
    protected void CheckBox1_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (sender == this.CheckBox2)
            ...
            quest = 3;
        MemberExercisePlan myPlan = dbAccess.GetCurrentMemberPlan(PrizeMemberAuthUtils.GetMemberID());
        dbAccess.UpdateOrientationWeekDayResult(myPlan.Id, 3, quest, cb.Checked);
    }
}