...
<div class="tab-inner-content">
    <div class="d-flex justify-content-end content-nav-action sec mb-4">
        <a id="dayView2" class="c_grey" href="/orientation/day-5">
    ...
    <div class="row">
        <div class="col-lg-10 push-lg-1">
            ...
            <p>Today’s exercise from the 7 primal movement patterns is the lunge. However, depending on your program, I want you to focus on a particular variation of the lunge.</p>
