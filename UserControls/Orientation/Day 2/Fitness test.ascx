...
<asp:TextBox ID="result" runat="server" CssClass="hidden-xl-down"></asp:TextBox>
        ...
        <asp:Button ID="btnTaskDone" class="text-center-sp btn btn-secondary  c_y sec" OnClientClick="getResult()" runat="server" Text="TASK COMPLETED >" OnClick="btnTaskDone_Click"/>
    </div>
</div>
<style>
.pg-l,
