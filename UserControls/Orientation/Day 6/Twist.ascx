...
<div class="tab-inner-content">
    ...
    <div class="row">
        <div class="col-lg-10 push-lg-1">
            ...
            <h5 class="c_y mt-4">Today’s exercise is the twist.</h5>
             <p>However, depending on your program, I want you to focus on a particular variation of the twist.</p>
            ...
            <div class="row loc-gym pg-g">
                <div class="col-md-4 ori-1-3-demo mb-4">
                    ...
                    <p><strong>Cable woodchop</strong></p>
                ...
                <div class="col-md-4 ori-1-3-demo mb-4">
                    ...
                    <p><strong>Palloff press</strong></p>
                    <a href="#" class="c_y">View demo ></a>
                </div>
            </div>
            <hr/>
